function checkUserNameAvailability(str)
{
	...
	xmlhttp.open("GET",plugin_dir_url( __FILE__ ) . "/mlm/ajax/check_username.php?action=username&q="+str,true);
	xmlhttp.send();
}
...
function checkReferrerAvailability(str)
{
	...
	xmlhttp.open("GET",plugin_dir_url( __FILE__ ) . "/mlm/ajax/check_username.php?action=sponsor&q="+str,true);
	xmlhttp.send();
