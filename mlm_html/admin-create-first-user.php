...
<table border="0" cellpadding="0" cellspacing="0" width="100%"  class="form-table">
	<tr>
		...
		<td>
			<input type="text" name="username" id="username" value="<?php echo  htmlentities(esc_attr ( $_POST['username']))?>" maxlength="20" size="37">
	...
	<tr>
		...
		<td>
			<input type="text" name="email" id="email" value="<?php echo  htmlentities(esc_attr( $_POST['email']));?>"  size="37" >
	...
	<th>
		...
		<td>
		<input type="text" name="confirm_email" id="confirm_email" value="<?php echo  htmlentities(esc_attr( $_POST['confirm_email']));?>" size="37" >
