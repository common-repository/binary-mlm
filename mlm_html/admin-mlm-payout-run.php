...
<div class="userslist">
	...
	<div class="helpmessage">
		...
		<p><?php echo  plugins_url()."/".MLM_PLUGIN_NAME?>/cronjobs/commission-bonus.php</p>
		...
		<p><?php echo  plugins_url()."/".MLM_PLUGIN_NAME?>/cronjobs/paycycle.php</p>
		
		<?php requiredProVersionFullPayout()?>
		
	</div>
	<div class="forms-ui">
		<p><h2 style="color:#0000CC;"><?php echo  $msg ?></h2></p>
		<br />
