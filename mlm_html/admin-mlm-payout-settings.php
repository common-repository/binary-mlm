...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
		<tr>
			...
			<td>
				<input type="text" name="pair1" id="pair1" size="2" value="<?php echo  htmlentities(esc_attr( $_POST['pair1']));?>"> : 
				<input type="text" name="pair2" id="pair2" size="2" value="<?php echo  htmlentities(esc_attr( $_POST['pair2']));?>">
		...
		<tr>
			...
			<td>
				<input type="text" name="initial_pair" id="initial_pair" size="2" value="<?php echo  htmlentities(esc_attr( $_POST['initial_pair']));?>">
		...
		<tr>
			...
			<td>
			<input type="text" name="initial_amount" id="initial_amount" size="10" value="<?php echo  htmlentities(esc_attr( $_POST['initial_amount']));?>">
		...
		<tr>
			...
			<td>
			<input type="text" name="further_amount" id="further_amount" size="10" value="<?php echo  htmlentities(esc_attr( $_POST['further_amount']));?>">
		...
		<tr>
			...
			<td>
			<input type="text" name="service_charge" id="service_charge" size="10" value="<?php echo  htmlentities(esc_attr( $_POST['service_charge']));?>">
		...
		<tr>
			...
			<td>
			<input type="text" name="tds" id="tds" size="10" value="<?php echo  htmlentities(esc_attr( $_POST['tds']));?>">&nbsp;%
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
		<tr>
			...
			<td>
				<input type="text" name="pair1" id="pair1" size="2" value="<?php echo  $mlm_settings['pair1'];?>"> : 
				<input type="text" name="pair2" id="pair2" size="2" value="<?php echo  $mlm_settings['pair2'];?>">
				<div class="toggle-visibility" id="admin-mlm-pair"><?php _e('Please mention here pair ratio.')?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="initial_pair" id="initial_pair" size="2" value="<?php echo  $mlm_settings['initial_pair'];?>">
				<div class="toggle-visibility" id="admin-mlm-initial-pair"><?php _e('Please mention here initial pair.')?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="initial_amount" id="initial_amount" size="10" value="<?php echo  $mlm_settings['initial_amount'];?>">
				<div class="toggle-visibility" id="admin-mlm-initial-amount"><?php _e('Please mention here initial amount.')?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="further_amount" id="further_amount" size="10" value="<?php echo  $mlm_settings['further_amount'];?>">
				<div class="toggle-visibility" id="admin-mlm-further-amount"><?php _e('Please mention here further pair amount.')?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="service_charge" id="service_charge" size="10" value="<?php echo  $mlm_settings['service_charge'];?>">
				<div class="toggle-visibility" id="admin-mlm-service-charege"><?php _e('Please specify service charge.')?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="tds" id="tds" size="10" value="<?php echo  $mlm_settings['tds'];?>">&nbsp;%
				<div class="toggle-visibility" id="admin-mlm-tds"><?php _e('Please specify TDS.')?></div>
			</td>
		</tr>
		</table>
