...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>Total on Left Leg: <?php echo  $leftLegUsers?></td>
		...
		?>
		<tr>
		<td colspan="2"><a href="?page_id=<?php echo  get_post_id('mlm_left_group_details_page');?>" style="text-decoration: none">View All</a></td>
		</tr>
	</table>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>Total on Right Leg: <?php echo  $rightLegUsers?></td>
		...
		?>
		<tr>
		<td colspan="2"><a href="?page_id=<?php echo  get_post_id('mlm_right_group_details_page');?>" style="text-decoration: none">View All</a></td>
		</tr>
	</table>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>My Personal Sales: <?php echo  $personalSales?></td>
		...
		?>
		<tr>
		<td colspan="2"><a href="?page_id=<?php echo  get_post_id('mlm_personal_group_details_page');?>" style="text-decoration: none">View All</a></td>
		</tr>
	</table>
